           ...
           <form className="form" onSubmit={handleSubmit}>
               <h1>Get started with us today!</h1>
                ...
                <div className="form-inputs">
                    ...
                    <input id="password2" type="password" name="password2" className="form-input" placeholder="Enter your password again" value={values.password2} onChange={handleChange}/>
